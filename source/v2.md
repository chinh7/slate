...
nonce || a strictly increasing number, uniquely created for each request. We recommend using a millisecond timestamp, e.g `1459142524488`
user_id || your `User ID`

After constructing the auth payload, you need to sign it with your secret using HMAC-SHA256 (HS256). You can choose to manually sign by following [JWT specs](https://jwt.io/introduction/). But we highly recommend using a [JWT library](https://jwt.io/#libraries-io), which is available in a wide range of programming languages.
<br>
