...
## Get Executions generated by Margin Trades (Positions)

> GET /executions/trade_summaries
...
```
<aside class="notice">
  Executions with PnLs are those used to close the trade.
</aside>
